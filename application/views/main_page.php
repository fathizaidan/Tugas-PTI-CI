...
<body class="skin-blue">
  ...
  $(document).ready(function() {
    ...
    // Create an array of random colors for each product
      ...
      data: {
        ...
        datasets: [{
          ...
          backgroundColor: [
              ...
              'rgb(255, 215, 0)',     // Gold
              'rgb(255, 69, 0)' 
						],  // Apply the array of colors to each bar
            borderColor: 'rgb(255, 99, 132)',      // Set border colors to match background
          borderWidth: 1
        }]
      },
      options: {
